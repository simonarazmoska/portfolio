...
export const Footer = () => {
  return (
    <Box className="tw-h-[460px] tw-bg-textMain tw-flex tw-flex-col tw-px-24 tw-py-20 tw-gap-[90px] tw-justify-center tw-items-start">
  ...
  return (
    <Box className="tw-w-[224px] tw-flex tw-flex-col tw-gap-4 tw-items-start">
      ...
      <Box className="tw-flex tw-flex-col tw-gap-2">
        <Link href={linkUrl} underline="none" className="tw-cursor-pointer tw-gap-2 tw-py-2 tw-flex tw-items-center">
          <Typography variant="title" className="tw-text-primary">
            {linkText}
          </Typography>
